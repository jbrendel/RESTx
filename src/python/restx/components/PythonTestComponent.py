...
# -------------------------------------------------------
class PythonTestComponent(BaseComponent):
    ...
    PARAM_DEFINITION = {
                           ...
                           "some_parameter" :    ParameterDef(PARAM_STRING, "Short description of this parameter",
                                                              required=False, default = "This is a test"),
    ...
    SERVICES         = {
                           ...
                           # exact function name.
                           "some_subresource" : {
                               "output_types" : [ "application/json", "application/xml" ],
                               ...
                               "params" : {
                                   ...
                                   "text" : ParameterDef(PARAM_STRING, "This is a text parameter",
                                                         default="some text", required=False),
    ...
    def some_subresource(self,
        ...
        """
        print "@@@ Some parameter: ", self.some_parameter
        print "@@@ Another param:  ", self.another_parameter
        print "@@@ Third param:    ", self.third_parameter
        data = "Python test component"
