...
public class RestxParameter
{
    ...
    protected final static String[] KNOWN_TYPES = {PARAM_STRING, PARAM_PASSWORD, PARAM_BOOL, PARAM_NUMBER,
        PARAM_URI};
    ...
    /**
     * Take an object (either boolean or string) and return boolean value. If the
     * value is a string and is either "y", "yes", "t", "true" or "1" then this
     * returns 'true', otherwise 'false'
     * 
     * @param val An object to be interpreted as a boolean value, either a boolean or
    ...
    protected boolean boolConvert(Object val) throws RestxClientException
    {
        ...
        {
            final String valStr = ((String) val).toLowerCase();
            if (valStr.equals("y") || valStr.equals("yes") || valStr.equals("t") || valStr.equals("true")
                || valStr.equals("1"))
            {
                return true;
            }
    ...
    /**
     * Convert an object (either a String or a Number) to a Number. If the value is a
     * string then we return BigDecimal. Otherwise, it returns the value object
     * itself.
     * 
     * @param val Either a Number object or a String representing a number.
     * @return The corresponding Number object, either Integer, Float, Double or
     *         BigDecimal.
     * @throws RestxClientException
     */
    ...
    /**
     * Convert an object to the specified type. The type is specified as a string
     * (one of our known types). The function then attempts to take the object, which
     * may be a string or other type and convert it to the specified type.
     * 
     * @param val A value object.
     * @param typeName The name of the type. Has to be from our KNOWN_TYPES list.
     * @return Either String, Integer, Boolean, Float, Double or BigDecimal.
     * @throws RestxClientException
     */
    ...
    /**
     * Construct a new RestxParameter. This takes a parameter definition hash map as
     * they would be received straight from the server. No prior sanity checking
     * needs to be performed on it, since this constructor properly parses and
     * interprets this map.
     * 
     ...
     * @throws RestxClientException
     */
    public RestxParameter(String name, Map<String, ?> pdef) throws RestxClientException
    {
        this.name = name;
        try
        {
            ...
            for (final String knownName : KNOWN_TYPES)
            {
            ...
            if (!required)
            {
                final Object defaultValRepr = pdef.get(DEFAULT_KEY);
                if (defaultValRepr == null)
                {
                    throw new RestxClientException("No default value specified for optional parameter '"
                                                   + name + ".");
                }
    ...
    /**
     * Used to check whether a proposed value object is of the right type for this
     * parameter. Returns nothing if all is well, otherwise throws exception.
     * 
    ...
    /**
     * Returns the string that was used to define the type. This is one of the
     * KNOWN_TYPES.
     * 
    ...
    /**
     * Returns the object holding the default value for this parameter. Might be null
