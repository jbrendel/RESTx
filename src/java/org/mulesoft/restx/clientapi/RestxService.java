 ...
 * representation can be used by clients to find out about service capabilities.
 */
public class RestxService
{
    ...
    protected Map<String, RestxParameter> parameters;
    protected List<String> positional_params;

    /**
     * Create a new RestxService definition. This takes a service definition hash map
     * as they would be received straight from the server. No prior sanity checking
    ...
    public RestxService(String name, Map<String, ?> sdef) throws RestxClientException
    {
        this.name = name;
        try
        {
            ...
            positional_params = (List<String>) sdef.get(POSITIONAL_PARAMS_KEY);

            // Parse the parameter dictionary and attempt to translate
            // this to a dictionary of proper RestxParameter objects.
            final Map<String, Map<String, ?>> pdict = (Map<String, Map<String, ?>>) sdef.get(PARAMS_KEY);
            if (pdict != null)
            {
     ...
     */
    public Map<String, RestxParameter> getAllParameters()
    {
        return parameters;
    }
    ...
    /**
     * Return an array with all the positional parameter names. The order of entries
     * in that array reflects the order in which the positional parameters need to be
     * arranged.
     * 
    ...
    public String[] getPositionalParamNames()
    {
        ...
        final Object[] pp = positional_params.toArray();
        final String[] strArray = new String[pp.length];
