 ...
 * clients to find out about a component and its capabilities. It is also the
 * starting point for creating a new resource that's based on this component.
 */
public class RestxComponent
{
    ...
    /**
     * Create a new RestxComponent object, representing a RESTx component in the
     * client.
     * 
    ...
    public RestxComponent(RestxServer server, Map<String, ?> cdesc) throws RestxClientException
    {
        this.server = server;
        ...
        try
        {
            ...
            // be surprised...
            final Map<String, Map<String, ?>> rcpMap = (Map<String, Map<String, ?>>) cdesc.get(RCP_KEY);
            rcpDescriptionParam = new RestxParameter(RCP_DESC_KEY, rcpMap.get(RCP_DESC_KEY));
            rcpSuggestedNameParam = new RestxParameter(RCP_SUGGESTED_NAME_KEY,
                rcpMap.get(RCP_SUGGESTED_NAME_KEY));
        ...
        catch (final Exception e)
        {
            ...
            throw new RestxClientException("Server error: Could not process component meta data: "
                                           + e.getMessage());
        }
    }
     ...
     * {@link RestxResourceTemplate} object. This method sends a request to this
     * components own URI.
     * 
     ...
     * @throws RestxClientException
     */
    protected Map<String, Object> createResource(Object rdict) throws RestxClientException
    {
    ...
    /**
     * Return the doc page for this component. This may generate a request to the
     * server for the component's docs. Once we receive the information, it is cached
     * so that we can reused it later on.
     * 
    ...
    public String getDocs() throws RestxClientException
    {
        if (doc == null)
        {
            final HttpResult res = server.jsonSend(docUri, null, null, 200, null);
            doc = (String) res.data;
        }
        return doc;
    }
    ...
    /**
     * Return definition of the description parameter. The description parameter is
    ...
    /**
     * Return definition of the suggested name parameter. The suggested name
     * parameter is used when creating a resource.
     * 
